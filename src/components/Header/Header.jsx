...
const Header = () => {
  return (
    <header className="bg-[#2a3042] text-white p-4 flex justify-between items-center">
      <div className="flex items-center">
        <button className="text-xl">☰</button>
        <input className=" outline-none	ml-4 p-1 bg-[#2a3042] rounded" type="text" placeholder="Search..." />
      </div>
      <div className="flex items-center space-x-4">
        <img
          ...
          alt="Profile"
        />
        <img className='w-[24px] cursor-pointer' src="data:image/jpeg;base64," alt="" />
        <BiCustomize className="text-xl cursor-pointer" />
        <RiFullscreenFill className="text-xl cursor-pointer" />
